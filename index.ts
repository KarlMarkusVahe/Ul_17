...
function initApp(freeMemory: number, freeDisk: number,  mailFn: any, initFn: any){
    if(freeMemory<100000){mailFn("Vaba mälu ainult "+freeMemory); return;}
    if(freeDisk<1000000){mailFn("Vaba kettaruumi ainult "+freeMemory+" baiti"); return;}
    initFn();
    mailFn("Rakendus käivitus")
}

//initApp(15000, sendLog);
initApp(1500000, 10000000, console.log, fakeInit);